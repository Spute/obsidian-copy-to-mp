...
export const STYLES = {
  ...
  'wechat-tech': {
    ...
    styles: {
      ...
      strong: 'font-weight: 700; color: #0066cc !important;', // background-color: #fff3cd !important; padding: 2px 4px; border-radius: 8px;',
      em: 'font-style: italic; color: #666 !important;',
